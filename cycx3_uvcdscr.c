...
const uint8_t CyCx3USBBOSDscr[] =
{
    ...
    0x06, 0x00, 0x00, 0x00,             /* Supported device level features - LPM support */
...
const uint8_t CyCx3USBSSConfigDscr[] =
{
    ...
    0xBE, 0x00,
#else
    0xA7,0x00,                          /* Total size of Class specific VS descr */
#endif
    ...
    /* Class specific Uncompressed VS frame descriptor 2 - 5MP@15fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    ...
    /* Class specific Uncompressed VS frame descriptor 3 - 720p@ 60fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    ...
    /* Class specific Uncompressed VS frame descriptor 4 - 640x480 @ 30 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
...
uint8_t const gl5MpProbeCtrl[CX3_APP_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
